...
function f_mainStart()
	...
	data.fadeTitle = f_fadeAnim(MainFadeInTime, 'fadein', 'black', sprFade) --global variable so we can set it also from within select.lua
...
function arcadeHumanvsCPU()
	...
	f_selectAdvance() --start f_selectAdvance() function from script/select.lua
...
function freeHumanvsCPU()
	...
	f_selectSimple() --start f_selectSimple() function from script/select.lua
	P2overP1 = false
end
