...
--;===========================================================
table.insert(t_extrasMenu,6,{id = textImgNew(), text = "CHRONICLES", gotomenu = "f_chroniclesMenu()"}) --Insert new item to t_extrasMenu table loaded by screenpack.lua
t_chroniclesMenu = {
	{id = textImgNew(), text = "STORY", gotomenu = "f_storyMenu()"},
	{id = textImgNew(), text = "VISUAL NOVEL", gotomenu = "f_vnMenu()"},
	--{id = textImgNew(), text = "QUIZ", gotomenu = "f_quizMenu()"},
}
--;===========================================================
--; CHRONICLES MENU (play special game modes)
--;===========================================================	
