...
local function f_createShopDat()
if stats.shopstock == nil or data.erase then stats.shopstock = {} end --Create space to sell shop items
end
f_createShopDat()
hookAdd(f_createShopDat()) --Allow reset via options the data generated by this module
