...
local function checkIntArgOLD(arg, maxBits, argName, func, maybeNil)
...
local function checkIntArg(arg, maxBits, argName, func, maybeNil)
	...
	assert(type(arg) == "number" and math.floor(arg) == arg and arg < maxVal and arg >= -maxVal or (maybeNil and arg == nil), string.format("Argument \"%s\" of function \"%s\" has to be a whole number <= %s", argName, func, tostring(maxVal)))
end
