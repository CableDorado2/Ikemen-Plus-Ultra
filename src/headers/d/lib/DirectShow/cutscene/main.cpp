         ...
         )
{
    ...
    //{
        //MessageBox(NULL, (LPCWSTR)L"Error trying play this scene", TEXT("Cutscene Error"), MB_OK | MB_ICONERROR);
        //exit(1);
    //}

    // Play movie
    hr = PlayCutscene(L"C:\\Users\\Petter Pino\\Music\\Wildlife.wmv", hInstance);
