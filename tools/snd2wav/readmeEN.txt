=============================================================================
snd2wav Ver. 2008/01/04 Author: doloop
=============================================================================
...
> snd2wav kfm.snd
This will create a wav file in the kfm folder, and a list of the files will be written to the kfm.txt file.
kfm.txt can be used with sndmaker.

> snd2wav kfm.snd mfk
This will create a wav file in the mfk folder, and a list of the files will be written to the mfk.txt file.

- How to Use (wav2snd)
This is the same as the sndmaker included with MUGEN.

Drag and drop the text file created with snd2wav.
